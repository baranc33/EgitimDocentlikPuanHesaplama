...
namespace Core.Models.Entities
{
    public class MimarlikEntity
    {
        ...
        #region Makaleler
                ...
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? MakalelerAhatirlatici { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? MakalelerAbasYazar { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public int MakalelerACount { get; set; } = 0;
                ...
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? MakalelerBhatirlatici { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? MakalelerBbasYazar { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public int MakalelerBCount { get; set; } = 0;
                ...
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? MakalelerChatirlatici { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? MakalelerCbasYazar { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public int MakalelerCCount { get; set; } = 0;
        ...
        #region Yayin
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? YayinAdoktora { get; set; } = default!;
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? YayinAkitap { get; set; } = default!;
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string?  YayinAyazarsayisi { get; set; } = default!;
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? YayinAhatirlatici { get; set; } = default!;
        ...
        #region Patent
                ...
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? PatentBmakalekitapbolum { get; set; }
                ...
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? PatentCdoktora { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? PatentCsayi { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? PatentCyazarsayisi { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public string? PatentChatirlatici { get; set; }
                [MaxLength(20, ErrorMessage = "En Fazla 20 karakter olabilir")] public int PatentCCount { get; set; } = 0;
