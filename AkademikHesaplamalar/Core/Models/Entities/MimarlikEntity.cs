...
namespace Core.Models.Entities
{
    public class MimarlikEntity
    {
        ...
        [MaxLength(100, ErrorMessage = "En Fazla 100 karakter olabilir")] public string? YayinAhatirlatici { get; set; } = default!;
        ...
        [MaxLength(100, ErrorMessage = "En Fazla 100 karakter olabilir")] public string? PatentChatirlatici { get; set; }
        public int PatentCCount { get; set; } = 0;
