...
app.MapControllerRoute("Egitim", "Egitim-Bilimleri-Doçentlik-Puan-Hesaplama", new { controller = "Science", action = "Egitim" });
...
app.MapControllerRoute("Mimarlik", "Mimarlik-Bilimleri-Doçentlik-Puan-Hesaplama", new { controller = "Science", action = "Mimarlik" });
app.MapControllerRoute("Muhendis", "Muhendis-Bilimleri-Doçentlik-Puan-Hesaplama", new { controller = "Science", action = "Muhendis" });
app.MapControllerRoute("Saglik", "Saglik-Bilimleri-Doçentlik-Puan-Hesaplama", new { controller = "Science", action = "Saglik" });
