...
namespace AkademikHesaplamalar.Helpers.Validaton
{
    public class CustomPasswordValidator : IPasswordValidator<MyUser>
    {
        public Task<IdentityResult> ValidateAsync(UserManager<MyUser>
            manager, MyUser user, string password)
