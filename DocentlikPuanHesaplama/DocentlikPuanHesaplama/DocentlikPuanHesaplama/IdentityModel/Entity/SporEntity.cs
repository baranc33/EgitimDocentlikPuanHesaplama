namespace DocentlikPuanHesaplama.IdentityModel.Entity
{
    public class SporEntity
    {
        ...
        public string? UluslarArasiAhatirlatici { get; set; }s
        ...
        public string? UluslarArasiBhatirlatici { get; set; }s
        ...
        public string? UluslarArasiChatirlatici { get; set; }s
        ...
        public string? UlusalAhatirlatici { get; set; }s
        ...
        public string? UlusalBhatirlatici { get; set; }s
        ...
        public string? YayinEhatirlatici { get; set; }s
        ...
        public string? YayinFhatirlatici { get; set; }s
        ...
        public string? YayinGhatirlatici { get; set; }s
        ...
        public string? ToplantiByazarsayisi { get; set; }s
